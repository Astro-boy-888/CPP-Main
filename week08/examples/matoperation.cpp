...
//AVX2方式求点积 intel加速指令
//AVX2是256位的向量运算指令集，可以一次处理8个float数据，因此可以提高计算效率
...
//NEON方式求点积 arm架构下的加速指令
//NEON是128位的向量运算指令集，可以一次处理4个float数据，因此可以提高计算效率
